...
class TreatmentDetail(db.Model):
    ...
    medication = relationship("MedicationDetail", back_populates="treatment")
    checkup = relationship("CheckUp", back_populates='treatment')
    procedure = relationship("ProcedureDetail", back_populates='treatment')